...
class Cart extends Base {
    ...
    public function cart3(){
        ...
        $result = calculate_price($this->user_id,$order_goods,$shipping_code,0,$address[province],$address[city],$address[district],$pay_points,$user_money,$coupon_id,$couponCode,$pay_tpye);
		if($result['status'] < 0)
			exit(json_encode($result));
	// 订单满额优惠活动
