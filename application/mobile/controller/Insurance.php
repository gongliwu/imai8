...
class Insurance extends MobileBase {
    private $is_wechat = 1;
    ...
    {   
        ...
        header('Location: ./orderdetail.html?ispay=1&order_id='.strval($order_id));
        exit();
    }
...
<pre>{$insurance_url}</pre>";
    ...
    public function orders()
    {
        ...
        $order_list = M('insurance_order')->where($where)->order('order_id DESC')->select();
