...
return	array(
	'system'=>array('name'=>'系统','child'=>array(
				...
				array('name' => '会员','child'=>array(
						...
						array('name'=>'导入积分','act'=>'import_points_page','op'=>'User'),
						array('name'=>'导入积分记录','act'=>'import_points_list','op'=>'User'),
				)),
	...
	'shop'=>array('name'=>'商城','child'=>array(
			...
			array('name' => '订单','child'=>array(
					array('name' => '实物订单列表', 'act'=>'index', 'op'=>'Order'),
    	    ...
    	    array('name' => '微信','child' => array(
    	        ...
    	        array('name' => '图文回复', 'act'=>'img', 'op'=>'Wechat'),
					...
					array('name' => '合作伙伴','child' => array(
						 array('name' => '合作伙伴列表', 'act'=>'index', 'op'=>'WorkPartner'),
				 )),

				 array('name' => '商品抽奖','child' => array(
					  array('name' => '抽奖设置列表','act'=>'index','op'=>'LuckTpl'),
						array('name' => '抽奖列表', 'act'=>'index', 'op'=>'LuckDraw'),
				)),
			/*
