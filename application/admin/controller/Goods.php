...
class Goods extends Base {
    ...
    public function goodsList(){      
        ...
        $ajaxGoodsListPage = session('ajaxGoodsListPage');
        $ajaxGoodsListPage = empty($ajaxGoodsListPage) ? 1 : $ajaxGoodsListPage;
        $this->assign('categoryList',$categoryList);
        $this->assign('brandList',$brandList);
        $this->assign('ajaxGoodsListPage',$ajaxGoodsListPage);
        return $this->fetch();
    }
    ...
    public function ajaxGoodsList(){            
        ...
        $ajaxGoodsListPage = I('p/d', 1);
        session('ajaxGoodsListPage', $ajaxGoodsListPage);
